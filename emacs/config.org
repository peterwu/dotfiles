...
** evil
   #+begin_src emacs-lisp
     (use-package evil
       ...
       :bind (:map pwy:evil-leader-nmap
                   :prefix "f" :prefix-map pwy:evil-find-map)
       :bind-keymap ("C-c f" . pwy:evil-find-map)
...
* fzf
  #+begin_src emacs-lisp
    (use-package fzf
      :ensure t
      :preface
      (defun pwy:fzf-find-file-in-current-dir ()
        (interactive)
      ...
      (defun pwy:fzf-find-file-in-same-dir ()
        (interactive)
        (fzf-find-file-in-dir (expand-file-name default-directory)))
      :bind (:map pwy:evil-find-map
                  ("b" . fzf-switch-buffer)
                  ("d" . fzf-find-file-in-dir)
                  ("f" . pwy:fzf-find-file-in-same-dir)
                  ("." . pwy:fzf-find-file-in-current-dir)
                  ("?" . fzf-recentf)))
  #+end_src
* gdb
  #+begin_src emacs-lisp
