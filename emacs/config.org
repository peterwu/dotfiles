...
#+begin_src emacs-lisp
  (use-package evil
    ...
    (defun pwy:evil-yank-to-clipboard ()
      (interactive)
      (evil-use-register ?+)
      (call-interactively 'evil-yank))

    (defun pwy:evil-yank-line-to-clipboard ()
      (interactive)
      (evil-use-register ?+)
      (call-interactively 'evil-yank-line))

    (defun pwy:evil-paste-after-from-clipboard ()
      (interactive)
      (evil-use-register ?+)
      (call-interactively 'evil-paste-after))

    (defun pwy:evil-paste-before-from-clipboard ()
      (interactive)
      (evil-use-register ?+)
    ...
    :bind (:map evil-motion-state-map
                :prefix "<SPC>" :prefix-map pwy:yank-map
                ("y" . pwy:evil-yank-to-clipboard)
                ("Y" . pwy:evil-yank-line-to-clipboard))
    :bind (:map evil-normal-state-map
                :prefix "<SPC>" :prefix-map pwy:paste-map
