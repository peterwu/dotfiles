...
** mode line
   #+begin_src emacs-lisp
     (use-package emacs
       ...
       (defvar-local wy:mode-line-evil-tag
         '(:eval (propertize evil-mode-line-tag
                             'face '(:foreground "dark violet" :weight bold))))
       (put 'wy:mode-line-evil-tag 'risky-local-variable t)
       ...
       (mode-line-format
        '(:eval
          (wy:mode-line-render
           ...
           (list
            "%e"
            wy:mode-line-evil-tag
            wy:mode-line-tab-bar-indicator
            "꞉"
